...
import { ArrowLeft, MapPin, Star, Calendar, Banknote, Users, Check } from 'lucide-react'
import BookingForm from '@/components/BookingForm'

export async function generateStaticParams() {
    // Note: Since we are using a database for dynamic content in the admin dashboard,
    // we return static params from the initial JSON for build-time optimization,
    // but the app will now be dynamically rendered (SSR/ISR).
